...
<legend>مدیریت کاربران</legend>
    <asp:RadioButton ID="UsersListRadio" runat="server"  Text="فهرست کاربران" GroupName="1"/>
    <asp:RadioButton ID="CreateUserRadio" runat="server" Text="ایجاد کاربر جدید" GroupName="1"/>
    <asp:RadioButton ID="PassResetRadio" runat="server" Text="بازنشانی گذرواژه کاربر" GroupName="1"/>
    <asp:RadioButton ID="UsersFileRadio" runat="server" Text="مدیریت فایل کاربران"  GroupName="1"/>
</fieldset>
</ContentTemplate>
    </asp:UpdatePanel>
    <br />
            ...
            <fieldset runat="server" id="fieldsetEditUser">
                ...
                <asp:Table id="tblEditUser" BorderWidth="0" runat="server" OnPreRender="EditUser_PreRender" width="100%">
                    <asp:TableRow>
                        ...
                        <asp:TableCell CssClass="field"><asp:Literal ID="litUsername" runat="Server" Text="<%# SelectedUser.UserName %>"/></asp:TableCell></asp:TableRow><asp:TableRow Height="10px">
                        <asp:TableCell></asp:TableCell><asp:TableCell></asp:TableCell></asp:TableRow><asp:TableRow>
                        ...
                        <asp:TableCell CssClass="fieldlabel"><asp:Localize ID="Localize3" runat="server" Text="<%$ Resources:stringsRes, adm_Users_IsApproved%>"></asp:Localize></asp:TableCell><asp:TableCell CssClass="field"><asp:CheckBox ID="chkIsApproved" runat="Server" ></asp:Checkbox></asp:TableCell></asp:TableRow><asp:TableRow>
                        <asp:TableCell CssClass="fieldlabel"><asp:Localize runat="server" Text="<%$ Resources:stringsRes, adm_Users_IsAdministrator%>"></asp:Localize></asp:TableCell><asp:TableCell CssClass="field"><asp:CheckBox ID="chkAdmin" runat="Server" ></asp:Checkbox></asp:TableCell></asp:TableRow><asp:TableRow>
                        <asp:TableCell CssClass="fieldlabel"><asp:Localize ID="Localize2" runat="server" Text="<%$ Resources:stringsRes, adm_Users_IsPowerUser%>"></asp:Localize></asp:TableCell><asp:TableCell CssClass="field"><asp:CheckBox ID="chkPowerUser" runat="Server" ></asp:Checkbox></asp:TableCell></asp:TableRow><asp:TableRow>
                            ...
                            <FinishCompleteButtonStyle CssClass="button" />
                                <WizardSteps>
                                    <asp:WizardStep runat="server" Title="Username" ID="stpUsername">
                                        <asp:ValidationSummary DisplayMode="List" EnableClientScript="true" EnableTheming="True" ID="ValidationSummary1" ValidationGroup="RecoverPasswordWizard" runat="server">
                                        </asp:ValidationSummary>
                                        <asp:TextBox ID="txtUsername" runat="server" ValidationGroup="RecoverPasswordWizard"></asp:TextBox><asp:RequiredFieldValidator Display="None" ID="RequiredUsernameValidator" runat="server" ErrorMessage="<%$ Resources:StringsRes, ctl_CreateUserWizard_PasswordRequired %>" ControlToValidate="txtUsername" ValidationGroup="RecoverPasswordWizard"></asp:RequiredFieldValidator></asp:WizardStep><asp:WizardStep StepType="Complete"><asp:Label ID="lblResult" runat="Server"></asp:Label></asp:WizardStep></WizardSteps></asp:Wizard></td></tr></table></fieldset> </td></tr></table><br />
    <fieldset>
    <legend>مدیریت فایل کاربران</legend><table>
    <tr>
    <td><asp:Button ID="Button2" runat="server" Text="فهرست کامل کاربران" 
