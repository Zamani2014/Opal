<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LatestAccounces.aspx.cs" Inherits="Administration_BulletManagement_ProjectNews" MasterPageFile="~/Site.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="mainContent" Runat="Server">

<fieldset dir="rtl">
<legend style="direction: rtl"><strong>فهرست اطلاعیه های ویژه کاربران</strong></legend>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [LatestAnnounces]" 
        ConflictDetection="CompareAllValues" 
        DeleteCommand="DELETE FROM [LatestAnnounces] WHERE [ID] = @original_ID AND [Subject] = @original_Subject AND [News] = @original_News AND [DateTime] = @original_DateTime" 
        InsertCommand="INSERT INTO [LatestAnnounces] ([ID], [Subject], [News], [DateTime]) VALUES (@ID, @Subject, @News, @DateTime)" 
        OldValuesParameterFormatString="original_{0}" 
        
        
        
        UpdateCommand="UPDATE [LatestAnnounces] SET [Subject] = @Subject, [News] = @News, [DateTime] = @DateTime WHERE [ID] = @original_ID AND [Subject] = @original_Subject AND [News] = @original_News AND [DateTime] = @original_DateTime">
        <DeleteParameters>
