...
public partial class Administration_Users : PageBaseClass
{
    ...
    protected void gvUsers_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "delete_user":
                ...
                if (!Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.Administrators.ToString()))
                {
                ...
                else
                {
                    ...
                    if (Roles.GetUsersInRole(Opal.RoleNames.Administrators.ToString()).Length > 1)
                    {
                        DeleteUser();
                    }
                    else
    ...
    {
        OurMembershipUser memUser = (OurMembershipUser)SelectedUser;
        ...
        try
        {
            ...
            if (chkAdmin.Checked && !Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.Administrators.ToString()))
            {
                Roles.AddUserToRole(SelectedUserName, Opal.RoleNames.Administrators.ToString());
                if (Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString()))
                {
                    Roles.RemoveUserFromRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString());
                }
                else
                {
                    Roles.RemoveUserFromRole(SelectedUserName, Opal.RoleNames.Users.ToString());
                }
                chkPowerUser.Checked = false;
            }
            else if (!chkAdmin.Checked && Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.Administrators.ToString()))
            {
                // Remove admin Role from selected user
                if (Roles.GetUsersInRole(Opal.RoleNames.Administrators.ToString()).GetLength(0) > 1)
                {
                    Roles.RemoveUserFromRole(SelectedUserName, Opal.RoleNames.Administrators.ToString());
                    if (chkPowerUser.Checked)
                    {
                        Roles.AddUserToRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString());
                    }
                    else
                    {
                        Roles.AddUserToRole(SelectedUserName, Opal.RoleNames.Users.ToString());
                    }
                }
                else
                {
            ...
            // new role PowerUser
            else if (!chkAdmin.Checked && chkPowerUser.Checked && !Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString()))
            {
                Roles.AddUserToRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString());
                Roles.RemoveUserFromRole(SelectedUserName, Opal.RoleNames.Users.ToString());
            }
    ...
    {
        //insert role
        Roles.AddUserToRole(((CreateUserWizard)sender).UserName, Opal.RoleNames.Users.ToString());
    ...
    {
        if (SelectedUser != null && Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.Administrators.ToString()))
            return true;
        else
            return false;
    }
    ...
    {
        if (SelectedUser != null && Roles.IsUserInRole(SelectedUserName, Opal.RoleNames.PowerUsers.ToString()))
            return true;
        else
            return false;
    }
    ...
    {
        string Result = "";
        if (Roles.IsUserInRole(Eval("UserName", "{0}"), Opal.RoleNames.PowerUsers.ToString()))
            Result = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x&nbsp;&nbsp;&nbsp;";
    ...
    {
        string Result = "";
        if (Roles.IsUserInRole(Eval("UserName", "{0}"), Opal.RoleNames.Administrators.ToString()))
            Result = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x&nbsp;&nbsp;&nbsp;";
    ...
    {
        Response.Redirect("~/Administration/UsersList.aspx");
    }
}
