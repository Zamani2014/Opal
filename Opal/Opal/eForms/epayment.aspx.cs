...
public partial class eForms_epayment : PageBaseClass
{
    ...
    public static readonly string additionalData = "فرم الکترونیکی پرداخت حساب";
    long payerId = 0;
    ...
    {
        int ID = GenerateIDColumn.GetNewID("AccountChargeTbl");
        ...
        try
        {
            ...
            if (resultArray[0] == "0")
            {
                ...
                string query = "INSERT INTO AccountChargeTbl (ID, OrderID, Name, Price, UserName, BankName, SysDateTime, LocalDate, LocalTime, PaymentStatus) values (@ID, @OrderID, @Name, @Price, @UserName, @BankName, @SysDateTime, @LocalDate, @LocalTime, @PaymentStatus)";
                ...
                cmd.Parameters["@UserName"].Value = AccUserName;
