...
public partial class EasyControls_LatestAnnouncement : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string strSql = "SELECT * FROM LatestNews ORDER BY DateTime ASC";
        string strScrolling = "";
        ...
        try
        {
            ...
            while (sqlRdr.Read())
            {
                strScrolling = strScrolling + "<a style='color:#000000; text-decoration:none' href='#' OnClick=" + "javascript:window.open('LatestSiteNews.aspx?NewsID=" + sqlRdr.GetValue(0) + "','NewsDetail','width=960,height=700;toolbar=yes;');" + ">" + sqlRdr.GetValue(1) + ", " + sqlRdr.GetValue(3) + "</a><br>";
            }
