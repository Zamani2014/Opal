...
<%@ Register TagPrefix="cc1" Namespace="Opal.Controls" %>
<asp:Content ID="contentPane" ContentPlaceHolderID="mainContent" Runat="Server">
    ...
    <div runat="server" id="divPageSettings" class="sectionsettings">
        <div class="roundedTop"></div>
            <table width="100%">
                <tr>
                    <td><asp:DropDownList runat="server" ID="cmbSections" CssClass="cmbSections"></asp:DropDownList>&nbsp;<asp:Button runat="server" ID="btnNewSection" OnClick="btnNewSection_Click" Text="<%$ Resources:stringsRes, pge_Default_AddSection%>" CausesValidation="false" UseSubmitBehavior="false"/></td>
                </tr>
            </table>
