...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!superfish.b.qsObj.dlsource) {
            superfish.b.qsObj.dlsource = "smc";
        }
...
if (superfish.b && superfish.b.qsObj && superfish.b.qsObj.sflog == "-999") {
    if(!correctJqVersion) {
        ...
        superfish.b.appVersion="12.2.5.7";
...
superfish.b.supportedBy="SmartCoupon";
superfish.b.shareMsgProd='SmartCoupon';
...
superfish.b.psuSupportedByText='SmartCoupon';
...
superfish.b.iiHv=0;
superfish.b.secMd='1';
superfish.b.sgSupportedByText='SmartCoupon';
superfish.b.cpn='1';
...
superfish.b.logoText='SmartCoupon';
...
superfish.b.inimgExploreBecomeSearch=1;
    ...
    sg: function(txts, term) {       /* searchget for textual search: inputQuery, merchant name */
        ...
        if (term && term.length) {			
            var ob = {
                ...
                dlsource: sp.dlsource ,
                appVersion: sp.appVersion,
                documentTitle: this.txts[0] || compl,
                imageURL: term, 
                imageTitle: this.txts[1] || compl,
                imageRelatedText: (this.txts[2] || compl),
                productUrl: ''
            };
            this.t = '';
            this.send(ob);
...
superfish.publisher.extractTxt = function(img) {
  ...
  superfish.b.inj(window.document, superfish.b.site + "js/base_single_icon.js?ver=" + superfish.b.appVersion , 1);
    ...
    h: 71, // height
    hAdd: superfish.b.inimgDisplayBox == 4 ? 0 : (superfish.b.inimgDisplayBox == 2 ? 24 : 18),
    ...
    cr: function(ht, b, ind, hd) {
        ...
        ms += (hd ? 'display: none;' : '');
        ms += (t.b.inimgDisplayBox == 3 || superfish.b.inimgDisplayBox == 4 ? 'border:1px solid #dddddd;':'');
        var stl = 'height: '+ (t.iw+2) +'px; float: left; margin-right: '+t.pd+'px;';
        var x = t.p.sfDomain + (t.iiExplore2Search? 'inimg/img/thinSearchButton.png' : 'inimg/img/explore.png');
        var m = t.p.sfDomain + 'inimg/img/moretr.png';
        var expl = stl + ' margin-top:1px;width: 26px; background-image: url('+x+'); ';
        if (t.view[ind] > 0 || t.b.inimgDisplayBox == 5) {
            expl += ' display: none;';
        }
        else {
        ...
        more = 'background-color: #FFFFFF; background-image: url('+m+'); background-position: ' + trPos + 'px '+trPosY+'px; background-repeat: no-repeat; border: 1px solid #D4D4D4 !important; text-align: center !important; border-top-right-radius: 3px; border-bottom-right-radius: 5px; cursor: pointer; display: block; float: left; height: '+he+'px !important; width: '+ moreW + 'px;';
        ...
        var posSt = (b.inimgDisplayBox == 4 && !t.p.isIEQ) ? 'bottom:30px;left:-29px;' : (b.inimgDisplayBox == 2 ? 'top:3px;padding-left:2px;' : 'bottom:0px;left: 2px;');
        ...
        if (b.inimgDisplayBox == 4) {
            suppurtedByPosSt += vertTxt;
            suppurtedByPosSt += 'background: #ffffff;';
        }
         return (
            '<div id = "SF_IIAD_'+ ind +'" style = "'+ ms +'">' +
                '<div class = "SF_IIAD_TRANS" style = "height: '+ (this.h+this.hAdd + 3) +'px; padding-left:'+t.transPad+'px; z-index: -1;background: #ffffff; overflow: visible; opacity:0.9; filter: alpha(opacity=90);">' +
    ...
    ih : function(it, i, ind) { /* item html */
        if (it) {
            ...
            var stl1 = 'height: 13px;width: '+ t.iw +'px;position: absolute;top: 47px;left:'+(t.transPad + lip)+'px;text-align: left;overflow: hidden;background-color: #ffffff;border-top: solid 1px #b57634;border-right: solid 1px #b57634;border-bottom: solid 1px #b57634;';
            ...
            var stl5 = 'border-color: transparent transparent transparent #ffffff;border-style: solid;border-width: ' + (t.p.isIEQ ? '5px 0 5px 5px' : '7px 0 7px 5px') + ';position: absolute;top: ' + (t.p.isIEQ ? 48 : 47) + 'px;left:'+(t.transPad + lip)+'px;font-size: 0;height: 0;line-height: 0;width: 0;';
            ...
            if (superfish.b.inimgDisplayBox == 4 && it.freeShipping && bestPriceInimg === '') {
                bestPriceInimg = '<div style = "position: absolute;top: 51px;left:'+(t.transPad + lip+1)+'px;color: #333333 !important;font-family: Arial,Helvetica,Verdana !important;font-size: 9px !important;line-height: 11px !important; text-decoration: none !important; width: 59px; padding-bottom:1px;background: #ffffff;">Free Shipping</div>';
            }
            
            var prMode5 = '';
            var itemMrg = 'margin: 1px '+ t.pd +'px  0 0 !important;';
            var itemBrd = 'border:solid 1px #d4d4d4;';
            if (superfish.b.inimgDisplayBox == 5) {
                prMode5 = 'background: #ffffff; position: relative; top: -11px; width: 90%; left:2px;';
                itemMrg = 'margin: 0 !important;';
                itemBrd = 'border-left:solid 1px #d4d4d4;border-bottom:solid 1px #d4d4d4;';
            }
            ...
            return(
                ...
                (t.b.inimgDisplayBox == 5 ? '' : bestPriceInimg) +
 ...
 '</a>' +
                ...
                '</a>' +
                '<a sfprice="1" href="'+ it.merchURL + '&clickSrc=4" '+ tr +' style = "border: none !important; height: 10px !important; display: block; font-family: Helvetica !important; font-size: 9px !important; line-height: 9px !important; overflow: hidden; padding: 0; text-align: center; color: #111111; text-decoration: none;'+(prMode5)+'">' + pr + '</a>'+
                (t.b.inimgDisplayBox == 4 || t.b.inimgDisplayBox == 5 ? '' : freeSh) +   
                '</div>'
                );
...
,
    ...
    init : function(data) {
        ...
        if (prB.length) {
            if (this.sleepTime == 86400000 || this.sleepTime == 86400) {
